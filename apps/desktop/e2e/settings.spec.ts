...
// settings opens (the shell snapshots the store on open); the icon-rail
// geometry, theme mutation, and attention-ordered channel list then share
// one settings shell.
test('settings shell: back-icon rail, theme application, and remote-access attention order', async ({ window: page }) => {
